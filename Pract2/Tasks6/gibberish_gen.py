...
_dict = {"1": ["Коллеги,", "В то же время,",
               "Однако,", "Тем не менее,",
               "Следовательно,", "Соответственно,",
               "Вместе с тем,", "С другой стороны,"],
         "2": ["парадигма цифровой экономики",
         ...
         "3": ["открывает новые возможности для",
...
def text_gen_from_dict(length=0, indent_len=0, *, sep=' ', end='\n'):
    ...
    if length < 0 or indent_len < 0:
        raise Exception("Нельзя сгенерировать сообщение "
                        "при параметре ниже 0 / "
                        "Can't generate a message "
                        "with a parameter less than 0")
